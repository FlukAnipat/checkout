-- Import complete HSK 1 vocabulary from CSV data
-- Based on HSK 1_Flash cards_(500).csv

-- Clear existing HSK 1 data (optional - comment out if you want to keep existing data)
-- DELETE FROM vocabulary WHERE hsk_level = 1;

-- Insert HSK 1 vocabulary with examples
