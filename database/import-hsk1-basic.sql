-- Import basic HSK 1 vocabulary for testing
-- This script imports the first 20 words from HSK 1 with examples

-- Clear existing HSK 1 data (optional - uncomment if you want to start fresh)
-- DELETE FROM vocabulary WHERE hsk_level = 1;

INSERT INTO vocabulary (vocab_id, hsk_level, hanzi, pinyin, meaning, meaning_en, meaning_my, example, sort_order) VALUES
-- Word 1: 爱
...
SELECT 'Imported 20 HSK 1 basic words with examples' as message;
